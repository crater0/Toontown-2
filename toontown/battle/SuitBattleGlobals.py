...
# each cog track is stronger than the last, from sell(1) -> cash(2) -> law(3) -> boss(4)
# formula is (x+1)(x+[1+track])
# lvl 12 is [(x+1)(x+[1+track]) + ((x+1)(x+[1+track])* .1) rounded to nearest 5
