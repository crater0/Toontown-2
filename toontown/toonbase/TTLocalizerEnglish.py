...
CashbotS = 'a Cashbot'
SellbotS = 'a Sellbot'
SafetybotS = 'a Safetybot'
BossbotP = 'Bossbots'
LawbotP = 'Lawbots'
CashbotP = 'Cashbots'
SellbotP = 'Sellbots'
SafetybotP = 'Safetybots'
...
MusicTtsTheme = 'The Toontown 2.0 Theme'
